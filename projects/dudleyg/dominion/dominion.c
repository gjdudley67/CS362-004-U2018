...
void adventurerCard(struct gameState *state, int currentPlayer, int cardDrawn, int temphand[], int drawntreasure, int z){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerCard(state, currentPlayer, cardDrawn, temphand, drawntreasure, z);
      return 0;
